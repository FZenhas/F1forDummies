    ...
    <form action="db/teams/updateTeamsRanking.php" method="post">
        <thead>
            <tr>
                ...
                <th scope="col">Editar
                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Introduza o valor total de pontos">
                        <button class="btn btn-dark" type="button"><i class="bi bi-info-circle-fill"></i></button>
                    </span>
                </th>
            </tr>
        </thead>
