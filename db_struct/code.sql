...
VALUES (
        ...
        '1955-02-24',
        NULL,
        'Renault, Ferrari, McLaren e Williams',
        '4',
        'Img/Pilotos iconicos/alainprost.webp'
    ), (
        'Ayrton Senna',
        'Brasil',
        '1960-03-21',
        ...
        '3',
        'Img/Pilotos iconicos/ayrton-senna.webp'
    ), (
        'Michael Schumacher',
        'Alemanha',
        '1969-01-03',
        ...
        '7',
        'Img/Pilotos iconicos/michael-schumacher.webp'
    );
...
VALUES (
        ...
        'Ferrari',
        '0',
        'Img/Logos_equipas/alfa_romeo.png',
        'Img/Equipas_carros/AlfaRomeo.png',
        'https://www.sauber-group.com/motorsport/formula-1/',
        'https://www.instagram.com/alfaromeoofficial/',
        '52'
    ), (
        'Alpha Tauri',
        'Scuderia AlphaTauri',
        ...
        '0',
        'Img/Logos_equipas/alphatauri.jpg',
        ...
        'Renault',
        '2',
        'Img/Logos_equipas/alpine.jpg',
        'Img/Equipas_carros/alpine.png',
        'https://www.alpine-cars.co.uk/f1-news.html',
        ...
        'Mercedes',
        '0',
        'Img/Logos_equipas/aston_martin.jpg',
        ...
        'Ferrari',
        '0',
        'Img/Logos_equipas/Haas.jpg',
        'Img/Equipas_carros/haas.png',
        ...
        'Mercedes',
        '8',
        'Img/Logos_equipas/maclaren.jpg',
        ...
        'Mercedes',
        '8',
        'Img/Logos_equipas/mercedes.jpg',
        ...
        'Chefe da Equipa: Christian Horner',
        'Red Bull Powertrains',
        '4',
        'Img/Logos_equipas/redbull_logo.jpg',
        ...
        'Mercedes',
        '9',
        'Img/Logos_equipas/williams.jpg',
        'Img/Equipas_carros/williams.png',
        'https://www.williamsf1.com/',
        'https://www.instagram.com/williamsracing/',
        '6'
    );
...
VALUES (
        ...
        'Img/Circuito/circuito_bahrain.png',
        'Img/bandeiras/bahrain.jpg'
    ), (
        ...
        'Img/Circuito/circuito_saudi_arabia.png',
        'Img/bandeiras/saudi-arabia.jpg'
    ), (
        'FORMULA 1 HEINEKEN AUSTRALIAN GRAND PRIX 2022, Australia 2022',
        'Australia',
        '2022-04-08',
        '2022-04-10',
        'Albert Park Circuit',
        'Img/Circuito/cuicuito_australia.png',
        'Img/bandeiras/Australia.jpg'
    ), (
        'FORMULA 1 ROLEX GRAN PREMIO DEL MADE IN ITALY E DELL EMILIA-ROMAGNA 2022',
        'Itália',
        '2022-04-22',
        '2022-04-24',
        'Imola or Autodromo Enzo e Dino Ferrari',
        'Img/Circuito/circuito_Italy.png',
        'Img/bandeiras/italia.jpg'
    ), (
        ...
        'Img/Circuito/circuito_Miami.png',
        'Img/bandeiras/EUA.jpg'
    ), (
        ...
        'Img/Circuito/circuito_Espanha.png',
        'Img/bandeiras/Espanha.jpg'
    ), (
        ...
        '2022-05-29',
        'Circuit de Monaco',
        'Img/Circuito/circuito_monaco.png',
        'Img/bandeiras/Monaco.jpg'
    ), (
        ...
        '2022-06-12',
        'Baku City Circuit',
        'Img/Circuito/circuito_azerbaijao.png',
        'Img/bandeiras/azerbaijao.jpg'
    ), (
        ...
        'Img/Circuito/circuito_canada.png',
        'Img/bandeiras/Canada.jpg'
    ), (
        ...
        '2022-07-03',
        'Silverstone Circuit',
        'Img/Circuito/circuito_GB.png',
        'Img/bandeiras/UK.jpg'
    ), (
        ...
        '2022-07-10',
        'Red Bull Ring',
        'Img/Circuito/circuito_Austria.png',
        'Img/bandeiras/austria.gif'
    ), (
        ...
        '2022-07-24',
        'França',
        'Img/Circuito/circuito_Franca.png',
        'Img/bandeiras/Franca.gif'
    ), (
        ...
        '2022-07-31',
        'Hungaroring',
        'Img/Circuito/circuito_Hungria.png',
        'Img/bandeiras/hungria.gif'
    ), (
        ...
        'Img/Circuito/circuito_Belgica.png',
        'Img/bandeiras/belgica.jpg'
    ), (
        ...
        '2022-09-04',
        'Circuit Zandvoort',
        'Img/Circuito/circuito_Holanda.png',
        'Img/bandeiras/holanda.gif'
    ), (
        ...
        'Img/Circuito/circuito_MonzaIt.png',
        'Img/bandeiras/italia.jpg'
    ), (
        ...
        'Img/Circuito/circuito_Singapura.png',
        'Img/bandeiras/singapura.png'
    ), (
        ...
        'Img/Circuito/circuito_Japao.png',
        'Img/bandeiras/Japao.jpg'
    ), (
        ...
        'Img/Circuito/circuito_USA_Austin.png',
        'Img/bandeiras/EUA.jpg'
    ), (
        ...
        'Img/Circuito/circuito_Mexico.png',
        'Img/bandeiras/Mexico.gif'
    ), (
        ...
        'Img/Circuito/circuito_brasil.png',
        'Img/bandeiras/brasil.jpg'
    ), (
        ...
        '2022-11-20',
        'Yas Marina Circuit',
        'Img/Circuito/circuito_AbuDhabi.png',
        'Img/bandeiras/abu-dhabi.jpg'
    );
...
VALUES (
        ...
        'Img/Pilotos/Fernando-Alonso.jpg',
        '59'
    ), (
        '1',
        'Valtteri Bottas',
        ...
        '1989-08-28',
        'Finlândia',
        'Img/bandeiras/Finlandia.jpg',
        '0',
        'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error, cupiditate?',
        'https://www.instagram.com/valtteribottas/',
        'Img/Pilotos/Valtteri-Bottas-02.jpg',
        '46'
    ), (
        '2',
        'Pierre Gasly',
        ...
        '1999-05-30',
        'China',
        'Img/bandeiras/China.jpg',
        '0',
        'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error, cupiditate?',
        'https://www.instagram.com/zhouguanyu24/',
        'Img/Pilotos/guanyu-Zhou.jpg',
        '6'
    ), (
        '8',
        'Lewis Hamilton',
        ...
        'Img/Pilotos/Nicholas_Lafiti.jpg',
        '0'
    ), (
        '5',
        'Charles Leclerc',
        ...
        '1992-05-10',
        'Dinamarca',
        'Img/bandeiras/Dinamarca.jpg',
        '0',
        'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error, cupiditate?',
        'https://www.instagram.com/kevinmagnussen/',
        'Img/Pilotos/Kevin-Magnussen_.jpg',
        '22'
    ), (
        '7',
        'Lando Norris',
        ...
        'Img/Pilotos/George-Russell.png',
        '203'
    ), (
        '5',
        'Carlos Sainz',
        ...
        '1999-03-22',
        'Alemanha',
        'Img/bandeiras/Alemanha.jpg',
        '0',
        'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error, cupiditate?',
        'https://www.instagram.com/mickschumacher/',
        'Img/Pilotos/Mick-Schumacher-.jpg',
        '12'
    ), (
        '4',
        'Lance Stroll',
