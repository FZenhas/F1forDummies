<main class="container border my-2 border-2 rounded shadow">
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="nav-item">
      <a class="nav-link" id="nav-admin" href="index.php?p=admin-teams-ranking">Upadate Classificação Construtores</a>
    </li>
    <li class="nav-item">
      <a class="nav-link active" id="nav-admin" href="index.php?p=admin-race-results">Update Resultado Corridas</a>
    </li>
    <li class="nav-item">
  ...
  <table class="table table-striped table-dark"><?php include('db/grand-prix/get-gp-results.php') ?></table>
  </div>